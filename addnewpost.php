...
if(isset($_POST['submit'])) {
	...
	if(empty($Title)) {
		...
		global $Connection;
		$Query = "INSERT INTO admin_panel (datetime, title, category, author, images, post) VALUES ('$dateTime', '$Title', '$Category', '$Admin', '$Image', '$Post')";
				...
				<form action="addnewpost.php" method="post" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="Post" id="postarea" col="10" rows="20"></textarea>
						</div>
